  ...
  return (
    <section className="relative overflow-hidden" style={{ minHeight: 560 }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full h-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8" style={{ minHeight: 560 }}>

          {/* Texte gauche — centré verticalement */}
          <div className="flex flex-col justify-center gap-3 py-12 lg:py-16">
          ...
          {/* Images — même taille, collées au bas de la section */}
          <div className="relative hidden lg:flex justify-end items-end">

            {/* Bulle bleue claire */}
            <Image src="/images/bubble-blue-light.png" alt="" width={70} height={70}
              className="absolute top-8 right-12 z-20 animate-bounce" style={{ animationDuration: "3s" }} />

            {/* Bulle bleue foncée */}
            <Image src="/images/bubble-blue-dark.png" alt="" width={56} height={56}
              className="absolute top-1/2 left-4 z-20 animate-bounce" style={{ animationDuration: "4s", animationDelay: "1s" }} />

            {/* Bulle verte */}
            <Image src="/images/bubble-green.png" alt="" width={52} height={52}
              className="absolute top-1/3 right-4 z-20 animate-bounce" style={{ animationDuration: "3.5s", animationDelay: "0.5s" }} />

            {/* Fille — même taille que le garçon */}
            ...
            {/* Garçon — même taille, collé à la fille */}
